      ...
      <div className="lg:flex px-10  pt-20 space-y-14 lg:space-y-0 ">
        ...
        <div className="space-y-4">
          ...
          <p className="max-w-sm leading-8">
            ...
            Goods, Quality Check, Storage, Dispatch, Reporting and End Customer
        ...
        <div className="px-10  space-y-10">
          <div>
            ...
            <p className="text-[#ff5e15] text-2xl font-bold cursor-pointer">+91 9912 742 555</p>
          </div>
          <div>
            <p className="text-white">Mail Us</p>
            <p className="text-[#1065cd] text-2xl font-bold cursor-pointer">sales@venovet.com</p>
          </div>
        </div>
      </div>
      </div>
