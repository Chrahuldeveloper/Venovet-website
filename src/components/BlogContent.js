...
export default function BlogContent() {
  return (
    <main className="p-5 shadow-md lg:max-w-3xl">
      <div>
        <div>
          <img src="https://venovet.com/assets/images/s1.jpg" alt="" />
        </div>
        ...
        <div className="mt-4">
          ...
          <p>
            ...
            devised an integrated approach. Realising that the root cause of the
            challenges that the company was facing was the lack of an efficient
            3PL network, we helped design and create the same around its
            manufacturing plants and regional distribution centres.
          </p>
          </div>
