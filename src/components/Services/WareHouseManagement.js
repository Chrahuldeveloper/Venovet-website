      ...
      <div className="flex flex-col items-start space-y-4 lg:space-x-10 lg:flex-row mt-7 lg:space-y-0">
        ...
        <div className="max-w-lg space-y-3.5">
          ...
          <p className="text-[#7a7a7a] text-sm leading-6">
            ...
            centres in a dedicated/shared services model focused on driving 100%
            order fulfilment. We utilise efficient resource management and
            automation techniques coupled with digitally-enabled purchase order
            and sales order management. This ensures seamless planning and
            execution of order fulfillment and provides real time inventory
